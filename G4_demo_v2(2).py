...
class Ui_MainWindow(object):
    def __init__(self,MainWindow):
        ...
        # # 设置上传的本地/远程文件路径
        self.local_video_path = "C:/Users/Krishlo/Desktop/test4/put/camera1.mp4"  ##本地文件路径
        self.remote_video_path = "/home/gzy/下载/testvideo/test.mp4"  ##上传对象保存的文件路径,一定要指定文件不可以是路径否则报错

        self.local_pic_path = "C:/Users/Krishlo/Desktop/test4/get/2.jpg"  ##本地文件路径
        self.remote_pic_path = "/home/gzy/下载/new darknet-master/darknet-master/predictions.jpg"  ##上传对象保存的文件路径,一定要指定文件不可以是路径否则报错


        self.local_csv_path = "C:/Users/Krishlo/Desktop/test4/get/get.csv"  ##本地文件路径
        ...
        self.count = 0
        self.videoWrite = cv2.VideoWriter(r"C:/Users/Krishlo/Desktop/test4/put/camera1.mp4",
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1143, 870)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.record_table = QtWidgets.QTableWidget(self.centralwidget)
        self.record_table.setGeometry(QtCore.QRect(0, 640, 1111, 171))
        ...
        self.btn_stop.setGeometry(QtCore.QRect(840, 570, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.btn_stop.setFont(font)
        self.btn_stop.setObjectName("btn_stop")
        self.video_label = QtWidgets.QLabel(self.centralwidget)
        self.video_label.setGeometry(QtCore.QRect(690, 10, 281, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.video_label.setFont(font)
        self.video_label.setObjectName("video_label")
        self.picture_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.picture_label_2.setGeometry(QtCore.QRect(120, 10, 281, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.take_pic.setGeometry(QtCore.QRect(10, 70, 421, 401))
        self.take_pic.setText("")
        self.take_pic.setObjectName("take_pic")
        self.btn_start = QtWidgets.QPushButton(self.centralwidget)
        self.btn_start.setGeometry(QtCore.QRect(600, 570, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.btn_start.setFont(font)
        self.btn_start.setObjectName("btn_start")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(450, 60, 641, 481))
        self.label.setText("")
    ...
    def table_insert(self):
        if cisu ==1:
            data = pd.read_csv("C:/Users/Krishlo/Desktop/test4/get/get1.csv")
        if cisu == 2:
            data = pd.read_csv("C:/Users/Krishlo/Desktop/test4/get/get2.csv")
        print("here")
        print(data.shape[0])
        Column = data.shape[0]
        print(Column)
    ...
    def show_camera(self):
        ...
        elif self.count==1100:
            img_show = cv2.imread(self.local_pic_path)
            show2 = cv2.resize(img_show, (420, 400))  # 把读到的帧的大小重新设置为 640x480
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "课堂教学辅助系统"))
...
class putv(QThread):
    ...
    def run(self):
        ...
        # 设置上传的本地/远程文件路径
        localpath = "C:/Users/Krishlo/Desktop/test4/put/camera1.mp4"  ##本地文件路径
...
class getcsv(QThread):
    ...
    def run(self):
        ...
        sftp = paramiko.SFTPClient.from_transport(tran)
        # 设置上传的本地/远程文件路径
        localpath = "C:/Users/Krishlo/Desktop/test4/get/get.csv"  ##本地文件路径
...
class getp(QThread):
    ...
    def run(self):
        ...
        sftp = paramiko.SFTPClient.from_transport(tran)
        # 设置上传的本地/远程文件路径
        localpath = "C:/Users/Krishlo/Desktop/test4/get/2.jpg"  ##本地文件路径
