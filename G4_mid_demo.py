...
class Ui_MainWindow(object):
    def __init__(self,MainWindow):
        ...
        self.local_pic_path = "D:/test.jpg"  ##本地图片路径
        ...
        #！！！修改视频保存地址
        self.videoWrite = cv2.VideoWriter(r"E:/put/camera1.mp4",
                                          cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 30, (640, 490))
    ...
    def setupUi(self, MainWindow):
        ...
        self.take_pic.setGeometry(QtCore.QRect(0, 110, 571, 491))
    ...
    def table_insert(self):
        ...
        # if cisu ==1:
        data = pd.read_csv("D:/桌面d盘/get.csv")
        # if cisu == 2:
    ...
    def show_camera(self):
        ...
        #90s截10s视频上传，并同时将结果显示在界面。
            ...
            show2 = cv2.resize(img_show, (570,490))  # 把读到的帧的大小重新设置为 640x480
            print(show2.shape)
        ...
        show = cv2.resize(self.image, (640, 490))  # 把读到的帧的大小重新设置为 640x480
